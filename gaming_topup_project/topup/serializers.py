...
class TopUpOrderSerializer(serializers.Serializer):
    ...
    def validate(self, data):
        try:
            ...
            raise serializers.ValidationError("Active game not found with given name and ID.")
        ...
        try:
            ...
            raise serializers.ValidationError("Product does not match the specified game or details.")
